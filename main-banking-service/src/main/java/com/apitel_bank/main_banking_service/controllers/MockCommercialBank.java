...
public class MockCommercialBank {
    ...
    @PostMapping("/mock-commercial-deposit-reply")
    public void onDepositReply(@RequestBody CommercialBankDepositReplyRequest request) {
        System.out.println("Mock Commercial Bank Deposit Reply request received: " + request.toString());
    }
}
